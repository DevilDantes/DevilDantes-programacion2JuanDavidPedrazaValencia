    ...
    def listar_productos(self):
        ...
        with open("D:\LoginApp\db_products.json", "r", encoding='utf-8') as self.file:
            ...
            for producto in self.db_products["productos"]:
                self.tablaproductos.insert("", "end", text=f'{producto["id"]}', values=(f'{producto["nombre"]}', f'{producto["precio"]}', f'{producto["stock"]}', f'{producto["image_path"]}', f'{producto["categoria"]}'))
